...
![](./../../../img/1stmodelset_wizard_fsxp3d.jpg){: style="width:70%"}
...
* select the flight simulator platform, that you want to create a first model set for: choose ``FSX`` for FSX or ``P3D`` for P3D.
